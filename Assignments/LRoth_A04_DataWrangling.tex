...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{EPAair.PM25.}\DecValTok{2018}\NormalTok{ <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/EPAair_PM25_NC2018_raw.csv"}\NormalTok{)}
\NormalTok{EPAair.PM25.}\DecValTok{2017}\NormalTok{ <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/EPAair_PM25_NC2017_raw.csv"}\NormalTok{)}
\NormalTok{EPAair.O3.}\DecValTok{2018}\NormalTok{ <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/EPAair_O3_NC2018_raw.csv"}\NormalTok{)}
\NormalTok{EPAair.O3.}\DecValTok{2017}\NormalTok{ <-}\StringTok{ }\KeywordTok{read.csv}\NormalTok{(}\StringTok{"./Data/Raw/EPAair_O3_NC2017_raw.csv"}\NormalTok{)}

\CommentTok{#2}
\KeywordTok{head}\NormalTok{(EPAair.PM25.}\DecValTok{2018}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{colnames}\NormalTok{(EPAair.PM25.}\DecValTok{2018}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summary}\NormalTok{(EPAair.PM25.}\DecValTok{2018}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{dim}\NormalTok{(EPAair.PM25.}\DecValTok{2018}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{head}\NormalTok{(EPAair.PM25.}\DecValTok{2017}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{colnames}\NormalTok{(EPAair.PM25.}\DecValTok{2017}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summary}\NormalTok{(EPAair.PM25.}\DecValTok{2017}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{dim}\NormalTok{(EPAair.PM25.}\DecValTok{2017}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{head}\NormalTok{(EPAair.O3.}\DecValTok{2018}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{colnames}\NormalTok{(EPAair.O3.}\DecValTok{2018}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summary}\NormalTok{(EPAair.O3.}\DecValTok{2018}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{dim}\NormalTok{(EPAair.O3.}\DecValTok{2018}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{head}\NormalTok{(EPAair.O3.}\DecValTok{2017}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{colnames}\NormalTok{(EPAair.O3.}\DecValTok{2017}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{summary}\NormalTok{(EPAair.O3.}\DecValTok{2017}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{dim}\NormalTok{(EPAair.O3.}\DecValTok{2017}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#3}
\NormalTok{EPAair.PM25.}\DecValTok{2018}\OperatorTok{$}\NormalTok{Date <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(EPAair.PM25.}\DecValTok{2018}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =} \StringTok{"%m/%d/%y"}\NormalTok{)}
\KeywordTok{class}\NormalTok{(EPAair.PM25.}\DecValTok{2018}\OperatorTok{$}\NormalTok{Date)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{EPAair.PM25.}\DecValTok{2017}\OperatorTok{$}\NormalTok{Date <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(EPAair.PM25.}\DecValTok{2017}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =} \StringTok{"%m/%d/%y"}\NormalTok{)}
\KeywordTok{class}\NormalTok{(EPAair.PM25.}\DecValTok{2017}\OperatorTok{$}\NormalTok{Date)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{EPAair.O3.}\DecValTok{2018}\OperatorTok{$}\NormalTok{Date <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(EPAair.O3.}\DecValTok{2018}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =} \StringTok{"%m/%d/%y"}\NormalTok{)}
\KeywordTok{class}\NormalTok{(EPAair.O3.}\DecValTok{2018}\OperatorTok{$}\NormalTok{Date)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{EPAair.O3.}\DecValTok{2017}\OperatorTok{$}\NormalTok{Date <-}\StringTok{ }\KeywordTok{as.Date}\NormalTok{(EPAair.O3.}\DecValTok{2017}\OperatorTok{$}\NormalTok{Date, }\DataTypeTok{format =} \StringTok{"%m/%d/%y"}\NormalTok{)}
\KeywordTok{class}\NormalTok{(EPAair.O3.}\DecValTok{2017}\OperatorTok{$}\NormalTok{Date)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#4}
\NormalTok{EPAair.PM25.}\FloatTok{2018.}\NormalTok{skinny <-}\KeywordTok{select}\NormalTok{(EPAair.PM25.}\DecValTok{2018}\NormalTok{, Date, }
\NormalTok{                                 DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, }
\NormalTok{                                 COUNTY, SITE_LATITUDE, SITE_LONGITUDE)}
\NormalTok{EPAair.PM25.}\FloatTok{2017.}\NormalTok{skinny <-}\StringTok{ }\KeywordTok{select}\NormalTok{(EPAair.PM25.}\DecValTok{2017}\NormalTok{, Date, }
\NormalTok{                                  DAILY_AQI_VALUE, Site.Name, AQS_PARAMETER_DESC, }
\NormalTok{                                  COUNTY, SITE_LATITUDE, SITE_LONGITUDE)}
\NormalTok{EPAair.O3.}\FloatTok{2018.}\NormalTok{skinny <-}\StringTok{ }\KeywordTok{select}\NormalTok{(EPAair.O3.}\DecValTok{2018}\NormalTok{, Date, DAILY_AQI_VALUE, Site.Name, }
\NormalTok{                                AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)}
\NormalTok{EPAair.O3.}\FloatTok{2017.}\NormalTok{skinny <-}\StringTok{ }\KeywordTok{select}\NormalTok{(EPAair.O3.}\DecValTok{2017}\NormalTok{, Date, DAILY_AQI_VALUE, Site.Name, }
\NormalTok{                                AQS_PARAMETER_DESC, COUNTY, SITE_LATITUDE, SITE_LONGITUDE)}

\CommentTok{#5}
\NormalTok{EPAair.PM25.}\FloatTok{2018.}\NormalTok{skinny}\OperatorTok{$}\NormalTok{AQS_PARAMETER_DESC <-}\StringTok{ "PM2.5"}
\NormalTok{EPAair.PM25.}\FloatTok{2017.}\NormalTok{skinny}\OperatorTok{$}\NormalTok{AQS_PARAMETER_DESC <-}\StringTok{ "PM2.5"}


\CommentTok{#6}
\KeywordTok{write.csv}\NormalTok{(EPAair.PM25.}\FloatTok{2018.}\NormalTok{skinny, }\DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }
          \DataTypeTok{file =}\StringTok{"./Data/Processed/EPAair_PM25_NC2018_Processed.csv"}\NormalTok{)}
\KeywordTok{write.csv}\NormalTok{(EPAair.PM25.}\FloatTok{2017.}\NormalTok{skinny, }\DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }
          \DataTypeTok{file =}\StringTok{"./Data/Processed/EPAair_PM25_NC2017_Processed.csv"}\NormalTok{)}
\KeywordTok{write.csv}\NormalTok{(EPAair.O3.}\FloatTok{2018.}\NormalTok{skinny, }\DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }
          \DataTypeTok{file =}\StringTok{"./Data/Processed/EPAair_O3_NC2018_Processed.csv"}\NormalTok{)}
\KeywordTok{write.csv}\NormalTok{(EPAair.O3.}\FloatTok{2017.}\NormalTok{skinny, }\DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }
...
\begin{Highlighting}[]
\CommentTok{#8}
\NormalTok{EPAair.combined <-}\StringTok{ }\KeywordTok{rbind}\NormalTok{(EPAair.O3.}\FloatTok{2017.}\NormalTok{skinny,EPAair.PM25.}\FloatTok{2018.}\NormalTok{skinny,}
\NormalTok{                         EPAair.O3.}\FloatTok{2017.}\NormalTok{skinny,EPAair.O3.}\FloatTok{2018.}\NormalTok{skinny)}
\KeywordTok{dim}\NormalTok{(EPAair.combined)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{EPAair.combined.wrangled <-}\StringTok{ }
\StringTok{  }\NormalTok{EPAair.combined }\OperatorTok{%>%}
...
\StringTok{  }\KeywordTok{select}\NormalTok{(Date, Month, Year, DAILY_AQI_VALUE}\OperatorTok{:}\NormalTok{SITE_LONGITUDE)}

\CommentTok{#10}
\KeywordTok{dim}\NormalTok{(EPAair.combined.wrangled)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{#11}
\KeywordTok{write.csv}\NormalTok{(EPAair.combined.wrangled, }\DataTypeTok{row.names =} \OtherTok{FALSE}\NormalTok{, }
...
\begin{Highlighting}[]
\CommentTok{#12a}
\NormalTok{EPAair.Summary.month <-}\StringTok{ }
\StringTok{  }\NormalTok{EPAair.combined.wrangled }\OperatorTok{%>%}
...
\CommentTok{#12b}
\NormalTok{EPAair.Summary.site <-}\StringTok{ }
\StringTok{  }\NormalTok{EPAair.combined.wrangled }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{group_by}\NormalTok{(Site.Name) }\OperatorTok{%>%}
\StringTok{  }\KeywordTok{summarise}\NormalTok{(}\DataTypeTok{meanAQI =} \KeywordTok{mean}\NormalTok{(DAILY_AQI_VALUE),}
            \DataTypeTok{minimumAQI =} \KeywordTok{min}\NormalTok{(DAILY_AQI_VALUE),}
            \DataTypeTok{maximumAQI =} \KeywordTok{max}\NormalTok{(DAILY_AQI_VALUE))}


\CommentTok{#13}
\KeywordTok{print}\NormalTok{(EPAair.Summary.month)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{print}\NormalTok{(EPAair.Summary.site)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
## # A tibble: 3 x 4
##   Site.Name   meanAQI minimumAQI maximumAQI
##   <fct>         <dbl>      <dbl>      <dbl>
## 1 Blackstone     38.0          0         97
## 2 Bryson City    34.2          4         78
## 3 Triple Oak     32.1          0         68
\end{verbatim}

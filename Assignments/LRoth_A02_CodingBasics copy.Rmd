...
```{r}
#1
sequence1 <- seq(1,100,4) #I am creating a sequence from 1 to 100 by 4s and naming it "sequence1"

#2
mean(sequence1) #Answer: 49 ; I am asking R to calculate the mean of sequence1
median(sequence1) #Answer: 49 ; I am asking R to find the median of sequence1

#3
mean(sequence1) > median(sequence1) #Answer: FALSE ; I am asking R to verify if the mean of sequence1 is greater than the median of sequence1
...
#7
Class.Results <- data.frame(Names, Test.scores, Pass) #assigning vectors to dataframe
names(Class.Results) <- c("Name", "Test Score", "Pass/Fail") #Labelling vectors in dataframe
...
} #I created a function that if the score is greater than 50, the answer will be "Pass" and if it is not greater than 50, the answer will be "Fail"

#10
pass.fail(5) # When putting in a score of 5 into the pass.fail function, the result is "Fail"

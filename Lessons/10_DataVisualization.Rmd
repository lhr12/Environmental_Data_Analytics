...
O3plot1 <- ggplot(EPAair) +
  geom_point(aes(x = Date, y = Ozone)) +
  theme_gray() #can add theme to any ggplot as if it is a layer
print(O3plot1)
...
```{r, fig.height = 3, fig.width = 4, warning = FALSE}
mytheme <- theme_classic(base_size = 14) + #increasing base font size to 14
...
theme_set(mytheme) #all ggplots use this theme from now on, can override w/in individual ggplot
...
O3plot7 <- ggplot(EPAair, aes(x = Date, y = Ozone)) +
  ...
  ylab(expression("O"[3]* " AQI Value")) + #brackets will give you subscripts and outside of quotation marks, superscript is a carrot (^)
  theme(axis.text.x = element_text(angle = 45,  hjust = 1)) 
print(O3plot7)  
#hjust moves things horizontally to the left
#vjust moves things vertically 
```
...
NvsP2 <-
  ...
  #xlab("Total Phosphorus (micro g/L)") +
  #ylab("Total Nitrogen (micro g/L)") +
...
# place your additional edits here
  labs(x = " ", y = "Concentraion in micro g/L", color = "Nutrient") +
